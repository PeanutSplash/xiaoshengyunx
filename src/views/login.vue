    ...
    <el-row type="flex" class="row-bg card" justify="center" align="bottom">
      <el-col :span="7" class="login-card">
        ...
        <el-form :model="loginForm" :rules="rules" ref="loginForm" label-width="21%" class="loginForm">
          ...
          <!-- <el-form-item label="记住密码" prop="remember" style="width: 380px;margin-left: 5vw;">
        ...
        <el-link type="primary" href="/reg"
          style="position: absolute; left: 2rem;bottom: 6.2rem;font-size: 0.8rem;">没有账号？点击注册</el-link>
      </el-col>
    </el-row>
  </div>
</template>
        ...
        if (valid) {
          ...
          this.$axios({
            ...
            if (res.data.code == 200) {
              ...
              // this.$cookie.set('token', res.data.data.token, { expires: 7 });//保存token到cookie
              this.$axios.defaults.headers['token'] = res.data.data.token;//配置请求头
